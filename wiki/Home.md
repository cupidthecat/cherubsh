...
The project currently targets the behavior of Bash 5.3.15 and Readline 8.3 patch 3. The workspace version is 0.5.0.
...
Those figures describe the v0.5.0 parity gates in this repository. Run the checks yourself before relying on a new revision. [Compatibility](Compatibility) explains what each suite proves, and [Testing](Testing) gives the commands.
